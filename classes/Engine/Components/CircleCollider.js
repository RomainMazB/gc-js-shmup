...
class CircleCollider extends Collider {
    ...
    constructor(pCollisionsManager, pSize, pOffsetX, pOffsetY) {
        let offsetX = pOffsetX !== undefined ? pOffsetX : -pSize
        let offsetY = pOffsetY !== undefined ? pOffsetY : -pSize
        super(pCollisionsManager, offsetX, offsetY);
        this.size = pSize
    }
