class Leather extends EnemyBase {
    constructor(pGameObjectManager, pCollisionsManager, pTransform, pAssetAtlas) {
        ...
        let spriteAnimator = new Animator('./assets/images/enemies/leather-armor.png', 88, 96, -44, -55)
